      ...
      >
        ...
        <div ref={sectionRef} className="relative pt-0 max-w-7xl mx-auto px-4 lg:px-0">
          ...
          <div className="mt-16 text-center">
            <a
              href="#contact"
              className="w-full sm:w-auto group relative inline-flex items-center justify-center px-8 md:px-10 py-4 md:py-5 font-black text-white transition-all duration-500 bg-blue-600 border border-blue-500 rounded-2xl md:rounded-2xl md:hover:bg-blue-700 md:hover:scale-105 shadow-[0_15px_40px_rgba(37,99,235,0.3)] overflow-hidden interactive"
            >
