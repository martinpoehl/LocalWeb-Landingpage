      ...
      <div className="container mx-auto px-5 md:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            <span className="text-blue-600 font-black uppercase tracking-[0.2em] text-[10px] md:text-xs mb-4 md:mb-8 block reveal-text">Partner für den Mittelstand</span>
            <h2 className="text-4xl md:text-7xl font-black text-slate-950 mb-6 md:mb-10 leading-tight reveal-text">
              Expertise für <br className="hidden md:block" /><span className="text-blue-600 italic">lokalen Erfolg.</span>
            </h2>
            <p className="text-slate-600 text-lg md:text-2xl leading-relaxed mb-8 md:mb-12 font-light reveal-text">
              Wir wissen, was lokale Unternehmen brauchen: Vertrauen, Klarheit und Ergebnisse. LocalWeb unterstützt Handwerker, Gastronomen und Fachhändler dabei, digital so professionell aufzutreten, wie sie ihre Arbeit vor Ort verrichten. Keine leeren Versprechen, sondern echte Weblösungen für die Nachbarschaft.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 md:gap-10 mb-10 md:mb-16 reveal-text">
              <div className="group">
                ...
                <div className="text-[10px] font-black uppercase tracking-widest text-slate-400">Lokale Betriebe</div>
              </div>
              <div className="group">
            ...
            <div className="flex flex-col sm:flex-row gap-4 reveal-text">
              <button className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 bg-blue-600 text-white rounded-xl md:rounded-2xl font-black hover:bg-blue-700 transition-all shadow-xl interactive">
                Referenzen
              </button>
              <button className="w-full sm:w-auto px-8 md:px-10 py-4 md:py-5 border-2 border-slate-100 text-slate-950 rounded-xl md:rounded-2xl font-black hover:bg-slate-50 transition-all interactive">
                Über uns
              </button>
            </div>
          </div>
