            ...
            <main className="pt-32 pb-20">
                ...
                <section className="container mx-auto px-6 mb-24 md:mb-32">
                    <div className="max-w-4xl mx-auto text-center">
                        <span className="text-blue-500 font-bold uppercase tracking-widest text-sm mb-4 block">Moderne Webseiten</span>
                        <h1 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tighter leading-tight">
                            Ihr digitaler <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Maßanzug.</span>
                        </h1>
                        <p className="text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto mb-12">
                            Wir entwickeln Webseiten, die nicht nur gut aussehen, sondern Ihre Besucher in Kunden verwandeln. Schnell, sicher und für jedes Gerät optimiert.
                        </p>
                        <a href="/#contact" className="inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-4 rounded-full font-bold hover:bg-blue-500 transition-all hover:scale-105">
                ...
                <section className="container mx-auto px-6 mb-24">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-colors">
                            ...
                            <p className="text-slate-400">Über 70% Ihrer Kunden kommen über das Smartphone. Wir sorgen dafür, dass Ihre Seite auf jedem Display perfekt aussieht.</p>
                        </div>
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-colors">
                            ...
                            <p className="text-slate-400">Ladezeiten unter 1 Sekunde. Das freut nicht nur Ihre Besucher, sondern wird auch von Google mit besserem Ranking belohnt.</p>
                        </div>
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-colors">
                            ...
                            <p className="text-slate-400">Keine Templates von der Stange. Wir gestalten ein Design, das exakt zu Ihrer Marke und Ihrer Zielgruppe passt.</p>
                        </div>
                    </div>
                </section>
